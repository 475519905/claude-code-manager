  ...
  useEffect(() => {
    ...
    const notifySessionEnded = (cid) => {
      ...
      if (typeof Notification !== 'undefined' && Notification.permission === 'granted') {
        try { new Notification('Codex Manager', { body: title }); return; } catch {}
      }
      fetch('/api/notify', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ title: 'Codex 对话已结束', body: title }),
      }).catch(() => {});
    };
      ...
      <main className="main">
        <div className="topbar">
          ...
          <div className="topbar-actions">
            <button className="icon-btn" title="刷新" onClick={reloadData}>
